...
var expectedMetricSetFromSample = map[string]interface{}{
	...
	"net.trackingClients":                    0,
	"net.clientsInTimeoutTable":              0,
	"system.allocatorAllocated":              0,
	"system.allocatorActive":                 0,
	"system.allocatorResident":               0,
	"system.usedMemoryVmEval":                0,
	"system.usedMemoryScriptsEval":           0,
	"system.numberOfCachedScripts":           0,
	"system.numberOfFunctions":               0,
	"system.numberOfLibraries":               0,
	"system.usedMemoryVmFunctions":           0,
	"system.ioThreadedReadsProcessed":        0,
	"system.usedMemoryVmTotal":               0,
	"system.usedMemoryVmTotalHuman":          "1.0k",
	"system.usedMemoryFunctions":             0,
	"system.usedMemoryScripts":               0,
	"system.usedMemoryScriptsHuman":          "216B",
	"system.allocatorFragRatio":              0,
	"system.allocatorFragBytes":              0,
	"system.allocatorRssRatio":               0,
	"system.allocatorRssBytes":               0,
	"system.rssOverheadRatio":                1.02,
	"system.memFragmentationBytes":           0,
	"system.memNotCountedForEvict":           0,
	"system.memReplicationBacklog":           0,
	"system.memTotalReplicationBuffers":      0,
	"system.memClientsSlaves":                0,
	"system.memClientsNormal":                0,
	"system.memClusterLinks":                 0,
	"system.memAofBuffer":                    0,
	"system.lazyfreedObjects":                0,
	"db.asyncLoading":                        0,
	"db.currentCowPeak":                      0,
	"db.currentCowSize":                      0,
	"db.currentCowSizeAge":                   0,
	"db.currentForkPerc":                     0,
	"db.currentSaveKeysProcessed":            0,
	"db.currentSaveKeysTotal":                0,
	"db.rdbSaves":                            0,
	"db.rdbLastLoadKeysExpired":              0,
	"db.rdbLastLoadKeysLoaded":               0,
	"db.aofRewrites":                         0,
	"db.aofRewritesConsecutiveFailures":      0,
	"db.moduleForkInProgress":                0,
	"db.moduleForkLastCowSize":               0,
	"db.expiredStalePercent":                 0,
	"db.expiredTimecapReachedCount":          0,
	"db.expireCycleCpuMilliseconds":          0,
	"db.evictedClients":                      0,
	"db.totalEvictionExceededTime":           0,
	"db.currentEvictionExceededTime":         0,
	"db.totalForks":                          0,
	"db.totalActiveDefragTime":               0,
	"db.currentActiveDefragTime":             0,
	"db.trackingTotalKeys":                   0,
	"db.trackingTotalItems":                  0,
	"db.trackingTotalPrefixes":               0,
	"db.unexpectedErrorReplies":              0,
	"db.totalErrorReplies":                   0,
	"db.dumpPayloadSanitizations":            0,
	"db.totalReadsProcessed":                 0,
	"db.totalWritesProcessed":                0,
	"db.ioThreadedReadsProcessed":            0,
	"db.ioThreadedWritesProcessed":           0,
	"db.replyBufferShrinks":                  0,
	"db.replyBufferExpands":                  0,
...
func TestGetRawMetricsFromSample(t *testing.T) {
	...
	td.Cmp(t, expectedRawInfoFromSample, metrics)
...
func TestPopulateMetrics(t *testing.T) {
	...
	td.Cmp(t, expectedRawInfoFromSample, ms.Metrics)
